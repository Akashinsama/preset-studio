 ...
 * 源：panel/src/panel-core.js + panel\src\antitrunc-stub.js + spec/groups.json
...
`;
  ...
  /* ══ FANO_ANTITRUNC_BEGIN ══════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════════ */
  /* ── 脚本层防截断（可选注入）──────────────────────────────────────
     这一版装的是：panel/src/antitrunc-stub.js（本工程自己写的空壳：防截断**没注入**，什么都不做）
     换一版：node tools/build-panel.mjs --with-antitrunc（或在编辑器「面板外观」里勾选）
     ═══════════════════════════════════════════════════════════════ */
  /* __FANO_ANTITRUNC_SLOT_BEGIN__ */
